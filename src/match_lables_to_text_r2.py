...
data = []
other_data = []
typos = { 'ambigous': 'ambiguous', 'electioms': 'elections', 'opo': 'open government'}
def fix(l):
...
df_good.to_csv("result_r2.csv", index=False)
df_bad.to_csv("result_bad_r2.csv", index=False)

df = pd.read_csv('result_r2.csv')
